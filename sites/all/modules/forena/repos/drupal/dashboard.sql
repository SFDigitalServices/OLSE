...
when D.field_current_claim_status_value = 'Closed_invalid' then 'Closed - no violation'
when D.field_current_claim_status_value = 'Closed_noclaimant_companydissolved' then 'Closed – no claimant/company dissolved'
...
LEFT join field_data_field_language L ON A.nid = L.entity_id
