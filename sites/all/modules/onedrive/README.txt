README.txt
------------
onedrive has been updated to use the latest version of google's API.  onedrive
now uses a client id and client secret which is described a bit more in the 
onedrive config and setup section.
The onedrive Module integrates Google Docs with Drupal. It provides a list of a
...
onedrive is not to be confused with BBoogle, which is Blackboards
integration with Google Docs -- but onedrive works much the same way
...
onedrive CONFIG AND SETUP
------------------------ 
Go to admin/settings/onedrive and put in a client id and client secret
...
----------------------------------------- 
This version of Drupal has a function called onedrive_file_upload
and works great using the latest gdrive api as of 1/30/2014 to
create and share a gdrive document.

Other api functions previously in onedrive, I'm hoping to port over
