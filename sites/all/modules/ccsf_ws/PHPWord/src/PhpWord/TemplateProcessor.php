...
class TemplateProcessor
{
    ...
    // setter and getter method to access word/document.xml
    public function getDocumentMainPart(){
        return $this->temporaryDocumentMainPart;
    }
    public function setDocumentMainPart($mainpart){
        $this->temporaryDocumentMainPart = $mainpart;
    }
    /**
    ...
    public function deleteField($fieldname)
    {
       $hasMatches = preg_match_all(
        ...
        foreach($matches[0] as $match){
            ...
            if( strpos($match, $fieldname) > 0){
                $this->temporaryDocumentMainPart = str_replace($match, '', $this->temporaryDocumentMainPart);
            }
