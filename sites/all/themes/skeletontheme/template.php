...
function skeletontheme_process_page(&$variables) {
   ...
   /* print "<pre>";
    var_dump($variables['page']['content']['system_main']['#node']);
    print "</pre>";
    */
...
/** custom code to add uid and rid to javascript */
global $user;
$rid = in_array('5',array_keys($user->roles)) ? 5 : 10;
drupal_add_js(array('forena' => array('uid' => $user->uid, 'rid' => $rid)), array('type' => 'setting'));
//EOF:Javascript
