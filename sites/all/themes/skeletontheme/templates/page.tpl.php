    ...
    <div class="container">
        ...
        <?php } ?>
            ...
            <div id="main">
                ...
                <?php
                  if($user->uid && (arg(2) == 'edit' || arg(1) == 'add')): ?>
                <div class="nav-menu-steps">
                   <!--ul class="steps"-->
                        <input id="click-claim" class="form-submit group-claim" type="button" value="Claim" name="claim" />
                        <input id="click-business" class="form-submit group-business" type="button" value="Business" name="business" />
                        <input id="click-contact" class="form-submit group-business-contact" type="button" value="Business Contact" name="contact" />
                        <input id="click-claimant" class="form-submit group-claimant" type="button" value="Claimant" name="claimant" />
                        <input id="click-activity" class="form-submit group-activity-sheet" type="button" value="Activity Sheet" name="activitysheet" />
                      <input id="click-payment-summary" class="form-submit group-payment-summary" type="button" value="Payment Summary" name="payment-summary" />
                   <!--/ul-->
                </div>
                <?php endif; ?>
                 <hr/>
        ...
        <div class="container">
            ...
            <div id="overlay-inAbox" class="overlay">
                ...
                <div class="wrapper">
                    ...
                    <br><br>
                    <img src="http://apps.sfgov.org/boa/sites/all/themes/skeletontheme/images/loading-x.gif" />
                </div>
            </div>
</div> <!-- /#wrap -->
